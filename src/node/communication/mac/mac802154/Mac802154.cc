...
{
	Mac802154Packet *macPacket;


	macPacket = new Mac802154Packet("802.15.4 MAC data packet", MAC_LAYER_PACKET);
...
void Mac802154::fromRadioLayer(cPacket * pkt, double rssi, double lqi)
{
	...
	switch (rcvPacket->getMac802154PacketType()) {
		...
		case MAC_802154_DATA_PACKET:{
			...
			trace()<<"-> MAC_802154_DATA_PACKET dst "<<dstAddr<<" source "<<rcvPacket->getSrcID();
