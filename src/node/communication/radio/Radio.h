...
class Radio: public CastaliaModule {
 private:
	...
	// data used to store Radio state time
	simtime_t timeTX, timeRX, timeSLEEP;

	// used to compute the time spent in a certain state
	simtime_t startOfState;

	// number of bytes received from the Wireless Channel
	int bytesRXed;
	double rxPowerConsumption;
	double rxDatarate;
