...
void ApplicationPacket::copy(const ApplicationPacket& other)
{
    ...
    this->sended_var = other.sended_var;
    this->filtered_var = other.filtered_var;
    this->compromised_var = other.compromised_var;
}
...
void ApplicationPacket::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->sended_var);
    doPacking(b,this->filtered_var);
    doPacking(b,this->compromised_var);
}
...
void ApplicationPacket::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->sended_var);
    doUnpacking(b,this->filtered_var);
    doUnpacking(b,this->compromised_var);
}
...
int ApplicationPacket::getSended() const
{
    return sended_var;
}

void ApplicationPacket::setSended(int sended)
{
    this->sended_var = sended;
}

int ApplicationPacket::getFiltered() const
{
    return filtered_var;
}

void ApplicationPacket::setFiltered(int filtered)
{
    this->filtered_var = filtered;
}

int ApplicationPacket::getCompromised() const
{
    return compromised_var;
}

void ApplicationPacket::setCompromised(int compromised)
{
    this->compromised_var = compromised;
}
...
int ApplicationPacketDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "sended")==0) return base+4;
    if (fieldName[0]=='f' && strcmp(fieldName, "filtered")==0) return base+5;
...
std::string ApplicationPacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: return long2string(pp->getSended());
        case 5: return long2string(pp->getFiltered());
...
bool ApplicationPacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 4: pp->setSended(string2long(value)); return true;
        case 5: pp->setFiltered(string2long(value)); return true;
