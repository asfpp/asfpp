...
class VirtualMobilityManager: public CastaliaModule {
 ...
 public:
	 ...
	 /* Public wrapper functions invoked by other submodules */
	 virtual void setLocationWrapper(double x, double y, double z, double phi = 0, double theta = 0);
	 virtual void setLocationWrapper(NodeLocation_type);
};
