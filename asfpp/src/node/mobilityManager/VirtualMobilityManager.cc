...
void VirtualMobilityManager::parseDeployment() {
	const char *ct;
	char *c; 
	int xlen = (double)network->par("field_x");
	int ylen = (double)network->par("field_y");
	int zlen = (double)network->par("field_z");
...
void VirtualMobilityManager::setLocationWrapper(double x, double y, double z, double phi, double theta)
{
    Enter_Method("setLocationWrapper() invoked by an external module");
    setLocation(x, y, z, phi, theta);
}

void VirtualMobilityManager::setLocationWrapper(NodeLocation_type newLocation)
{
    Enter_Method("setLocationWrapper() invoked by an external module");
