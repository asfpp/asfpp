//
// Generated file, do not edit! Created by nedtool 5.4 from node/communication/radio/RadioControlMessage.msg.
//
...
RadioControlMessage::RadioControlMessage(const char *name, short kind) : ::omnetpp::cMessage(name,kind)
{
...
const char *RadioControlMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
RadioControlCommand::RadioControlCommand(const char *name, short kind) : ::omnetpp::cMessage(name,kind)
{
...
const char *RadioControlCommandDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
