...
BaselineMacPacket::BaselineMacPacket(const char *name, short kind) : ::MacPacket(name,kind)
{
    this->HID = 0;
    this->NID = 0;
...
const char *BaselineMacPacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
BaselineBeaconPacket::BaselineBeaconPacket(const char *name, short kind) : ::BaselineMacPacket(name,kind)
{
...
const char *BaselineBeaconPacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
BaselineConnectionRequestPacket::BaselineConnectionRequestPacket(const char *name, short kind) : ::BaselineMacPacket(name,kind)
{
...
const char *BaselineConnectionRequestPacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
BaselineConnectionAssignmentPacket::BaselineConnectionAssignmentPacket(const char *name, short kind) : ::BaselineMacPacket(name,kind)
{
    this->recipientAddress = 0;
    this->senderAddress = 0;
...
const char *BaselineConnectionAssignmentPacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
BaselineBAckPacket::BaselineBAckPacket(const char *name, short kind) : ::BaselineMacPacket(name,kind)
{
...
const char *BaselineBAckPacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
BaselineTPollPacket::BaselineTPollPacket(const char *name, short kind) : ::BaselineMacPacket(name,kind)
{
...
const char *BaselineTPollPacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
