...
plot [0:600] [0:50] "cluster5_round_avg_complete" title "Smokestack 1" with linespoints ls 1, "cluster6_round_avg_complete" title "Smokestack 2" with linespoints ls 2 , "threshold" title "Threshold"  with lines  lt 5 lc 1 lw 4
