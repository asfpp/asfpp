...
python scripts/round.py cluster1.txt
python scripts/round.py cluster2.txt
python scripts/round.py cluster3.txt

# run py scripts to compute average values
python scripts/average.py cluster1_round.txt
python scripts/average.py cluster2_round.txt
python scripts/average.py cluster3_round.txt

# run py scripts to complete average files
python scripts/complete.py cluster1_round_avg 5
python scripts/complete.py cluster2_round_avg 5
python scripts/complete.py cluster3_round_avg 5

# compute average values of the entire scenario
python scripts/scenario_average.py cluster1_round_avg_complete cluster2_round_avg_complete cluster3_round_avg_complete
...
mv plot.plt plot
mv threshold plot
cp cluster1_round_avg_complete plot
cp cluster2_round_avg_complete plot
cp cluster3_round_avg_complete plot
