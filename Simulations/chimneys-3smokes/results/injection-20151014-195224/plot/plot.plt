...
plot [0:600] [20:80] "cluster1_round_avg_complete" title "Smokestack 1" with linespoints ls 1, "cluster2_round_avg_complete" title "Smokestack 2" with linespoints ls 2, "cluster3_round_avg_complete" title "Smokestack 3" with linespoints ls 3 , "threshold" title "Threshold"  with lines  lt 5 lc 1 lw 4
