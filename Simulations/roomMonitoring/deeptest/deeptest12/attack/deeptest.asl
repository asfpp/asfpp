...
from 50 every 0.1 do {
        ...
        change(fakePacket3, "APP.data", 20)
        change(fakePacket4, "APP.data", 20)
        change(fakePacket9, "APP.data", 20)
        change(fakePacket10, "APP.data", 20)
        change(fakePacket15, "APP.data", 20)
        change(fakePacket16, "APP.data", 20)
